...
Add-Content "$env:USERPROFILE\.git-credentials" "https://$($env:GitHubKey):x-oauth-basic@https://github.com`n"
...
else
{
    ...
    Try
    {
        ...
        git remote set-url origin git@github.com:microsoft/Test-NetStack.git
