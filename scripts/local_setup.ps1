...
Copy-Item C:\Test-RDMA\tools\NDK-Perf\NDKPerf.sys -Destination C:\Test-RDMA\tools\NDK-Perf
Copy-Item C:\Test-RDMA\tools\NDK-Perf\NDKPerfCmd.exe -Destination C:\Test-RDMA\tools\NDK-Perf

Copy-Item C:\Test-RDMA\tools\CTS-Traffic\ctsTraffic.exe -Destination C:\Test-RDMA\tools\CTS-Traffic
